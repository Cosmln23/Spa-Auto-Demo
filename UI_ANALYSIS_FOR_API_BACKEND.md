...
```javascript
const history = [
  { date: '2024-01-15', time: '09:00', name: 'Elena D.', service: 'Spălare exterior', status: 'confirmată' },
  { date: '2024-01-15', time: '11:00', name: 'C. Mihai', service: 'Spălare completă', status: 'confirmată' },
  { date: '2024-01-15', time: '15:00', name: 'Radu P.', service: 'Spălare exterior', status: 'anulată' },
];
```
