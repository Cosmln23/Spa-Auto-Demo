...
export function NeonButton({
  ...
  const base =
    'w-full h-14 rounded-2xl font-medium text-[15px] relative overflow-hidden border-2 transition-all duration-300';
  const primary =
    'border-cyan-400/70 text-white shadow-[inset_0_0_10px_rgba(0,212,255,.4),0_0_9px_3px_rgba(0,212,255,.1)] ' +
  ...
  const outline =
    'border-blue-400/60 text-blue-300 shadow-[inset_0_0_10px_rgba(0,180,255,.3),0_0_9px_3px_rgba(0,180,255,.1)] ' +
